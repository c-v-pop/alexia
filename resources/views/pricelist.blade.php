    ...
    <style>
      ...
      <div class="topnav">
        <a href="{{ route('index') }}" class="active">
          <img src="https://raw.githubusercontent.com/c-v-pop/alexia/refs/heads/main/public/images/logo.webp" alt="Beauty Salon Logo" style="height: 20px; vertical-align: middle;">
        </a>
        <div id="myLinks">
          <a href="{{ route('index') }}">Home</a>
          <a href="{{ route('treatments') }}">Treatments and Offers</a>
          <a href="{{ route('pricelist') }}">Pricelist</a>
          <a href="{{ route('services') }}">Services</a>
          <a href="{{ route('policies') }}">Info & Policies</a>
          <a href="{{ route('gallery') }}">Gallery</a>
          <a class="book-now" href="https://laalexiaatelier.booksy.com">Appointments</a>
        </div>
