  ...
  <header class="bg-opacity-60 bg-gray-900">
    <div class="flex justify-between items-center p-4">
      ...
      <nav class="hidden md:flex space-x-6">
        <a href="{{ route('index') }}" class="sm:text-base text-lg text-transparent bg-gradient-to-r from-[rgba(238,185,93,0.86)] via-[rgba(242,237,207,1)] to-[rgba(238,185,93,1)] bg-clip-text">Home</a>
        <a href="{{ route('treatments') }}" class="sm:text-base text-lg text-transparent bg-gradient-to-r from-[rgba(238,185,93,0.86)] via-[rgba(242,237,207,1)] to-[rgba(238,185,93,1)] bg-clip-text">Treatments</a>
        <a href="{{ route('services') }}" class="sm:text-base text-lg text-transparent bg-gradient-to-r from-[rgba(238,185,93,0.86)] via-[rgba(242,237,207,1)] to-[rgba(238,185,93,1)] bg-clip-text">Contraindications</a>
        <a href="{{ route('policies') }}" class="sm:text-base text-lg text-transparent bg-gradient-to-r from-[rgba(238,185,93,0.86)] via-[rgba(242,237,207,1)] to-[rgba(238,185,93,1)] bg-clip-text">Clinic Regulations</a>
        <a href="{{ route('gallery') }}" class="sm:text-base text-lg text-transparent bg-gradient-to-r from-[rgba(238,185,93,0.86)] via-[rgba(242,237,207,1)] to-[rgba(238,185,93,1)] bg-clip-text">Gallery</a>
      </nav>
    ...
    <div id="myLinks" class="hidden flex flex-col md:hidden bg-gray-900 p-4 space-y-2">
      <a href="{{ route('index') }}" class="block">Home</a>
      <a href="{{ route('treatments') }}" class="block">Treatments</a>
      <a href="{{ route('services') }}" class="block">Contraindications</a>
      <a href="{{ route('policies') }}" class="block">Clinic Regulations</a>
